...
{
    /// <summary>
    /// Interaction logic for DiffCallTreeForm.xaml
    /// </summary>
    public partial class DiffCallTreeForm : Window, IComparer, IDiffTreeOwner
    {
        ...
        private System.Drawing.Rectangle formRect = new System.Drawing.Rectangle(-1, -1, -1, -1);
        ...
        internal DiffCallTreeForm(TreeNodeBase root, AllocationDiff allocDiff)
        {
            InitializeComponent();
        }
        ...
        private void InitForm()
        {
            ...
            //}
            InitializeComponent();
            defaultFont = new Font(new System.Drawing.FontFamily("Tahoma"), 8);
        ...
        public Font GetFont(object obj, TreeNodeBase in_node)
        {
            ...
            return (fs == System.Drawing.FontStyle.Regular ? defaultFont : new Font(defaultFont, fs));
        ...
        public object GetInfo(object obj, TreeNodeBase node, int counterId)
        {
            long number = 0;
        ...
        private DiffColumn AddColumn(DiffTreeListView treeView, int counterId)
        {
            ...
            {
                c.Font = new Font(c.Font, System.Drawing.FontStyle.Bold);
            }
            return c;
        }
        #endregion
